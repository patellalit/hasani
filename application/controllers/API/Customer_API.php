...
class Customer_API extends CI_Controller {
    ...
    */
    public function customer_list(){
		...
		$data['data']['count_customers']= $this->customers_model->count_customers_api($request_params,$is_admin);
	    $data['data']['customers'] = $this->customers_model->get_customers_api($request_params,$is_admin);
		$this->json_response($data);
