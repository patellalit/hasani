...
class Admin_area extends CI_Controller {
    ...
    */
    public function index()
    {
        ...
        $gets = $_GET;
        unset($gets['per_page']);
        $config['base_url'] = base_url().'admin/area/page?'.http_build_query($gets);
    ...
    public function area_csv()
    {
        ...
        fputcsv($file,array('','City','State'));
        
        foreach ($data['area'] as $line)
        {
            $arr = array($line['id'],$line['area_name'],$line['city_name']);
            fputcsv($file,$arr);
            
        }
        
        fclose($file);
        echo $filename = "area.csv";exit;
