      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('admin/area', $attributes);
...
echo '&nbsp;<input type="button" id="getcsv" name="getcsv" value="Generate CSV" onclick="generatecsv(\''.base_url('admin/area/area_csv').'\')" class="btn btn-primary" onclick="" />';
            echo form_close();
            ?>
            ...
            <tbody>
                  ...
                  foreach($area as $row)
              {
				...
				echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/area/update/'.$row['id'].'" class="btn btn-info">view & edit</a>
                  <a href="'.site_url("admin").'/area/delete/'.$row['id'].'" class="btn btn-danger" onclick="return confirmDelete(this);">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
