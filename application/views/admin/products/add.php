      ...
      ?>
        <fieldset>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="item" value="<?php echo set_value('item'); ?>" >
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" id="" name="um" value="<?php echo set_value('um'); ?>">
		  ...
		  <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="sell_price_wholesale" value="<?php echo set_value('sell_price_wholesale'); ?>">
		  ...
		  <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="sell_price_wholesale_max" value="<?php echo set_value('sell_price_wholesale_max'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
          <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="sell_price_retail" value="<?php echo set_value('sell_price_retail'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
		  <div class="control-group">
            ...
            <div class="controls">
              <input type="text" name="sell_price_retail_max" value="<?php echo set_value('sell_price_retail_max'); ?>">
              <!--<span class="help-inline">OOps</span>-->
            </div>
          </div>
