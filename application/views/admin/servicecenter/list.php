      ...
      <div class="row">
        <div class="span12 columns">
          <div class="well">
            ...
            echo form_open('admin/servicecenter', $attributes);
...
echo '&nbsp;<input type="button" id="getcsv" name="getcsv" value="Generate CSV" onclick="generatecsv(\''.base_url('admin/servicecenter/center_csv').'\')" class="btn btn-primary" onclick="" />';
            echo form_close();
            ?>
          ...
          <table class="table table-striped table-bordered table-condensed">
            <thead>
              <tr>
                <th class="header">#</th>
                <th class="yellow header">Area</th>
				<th class="yellow header">Service center</th>
                <th class="yellow header">Service center address</th>
                <th class="yellow header">Zipcode</th>
                <th class="yellow header">Contact</th>
            ...
            <tbody>
                  ...
                  foreach($servicecenter as $row)
              {
				...
				echo '<td class="crud-actions">
                  <a href="'.site_url("admin").'/servicecenter/update/'.$row['id'].'" class="btn btn-info">view & edit</a>
                  <a href="'.site_url("admin").'/servicecenter/delete/'.$row['id'].'" class="btn btn-danger" onclick="return confirmDelete(this);">delete</a>
                </td>';
                echo '</tr>';
              }
              ?>      
