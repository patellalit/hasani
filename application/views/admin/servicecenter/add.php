    <div class="container top">
      ...
      if(isset($flash_message)){
        if($flash_message == TRUE)
        {
          echo '<div class="alert alert-success">';
            ...
            echo '<strong>Well done!</strong> new service center created with success.';
          echo '</div>';       
        }else{
      ...
      echo form_open('admin/servicecenter/add', $attributes);
      ?>
        <fieldset>
...
<?php echo form_dropdown('area_id',$option_area,'','class="span2 width230" id="area_id"'); ?>
          ...
          <div class="control-group">
            ...
            <div class="controls">
                <input type="text" id="servicecenter_name" name="servicecenter_name" value="<?php echo set_value('servicecenter_name'); ?>" >
            </div>
          </div>
<div class="control-group">
<label for="inputError" class="control-label">Service center address</label>
<div class="controls">
<input type="text" id="servicecenter_address" name="servicecenter_address" value="<?php echo set_value('servicecenter_name'); ?>" >
</div>
</div>
...
<div class="controls">
<input type="text" id="contactNo" name="contactNo" value="<?php echo set_value('contactNo'); ?>" >
</div>
</div>
