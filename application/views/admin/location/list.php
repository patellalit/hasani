...
echo '&nbsp;<input type="button" id="getcsv" name="getcsv" value="Generate CSV" onclick="generatecsv(\''.base_url('admin/location/location_csv').'\')" class="btn btn-primary" onclick="" />';
            echo form_close();
