      ...
      ?>
        <fieldset>
          <div class="control-group">
            ...
            <div class="controls">
            <?php echo form_dropdown('country_id',$option_country,$city[0]['country_id'],'class="span2 width230" id="country_id"  onchange="fetchState(this.value,\''.base_url().'admin/state/fetchState\')"'); ?>
            </div>
            </div>
<div class="control-group">
<label for="inputError" class="control-label">State</label>
<div class="controls">
<?php echo form_dropdown('state_id',$option_state,$city[0]['stateId'],'class="span2 width230" id="state_id"'); ?>
</div>
</div>
<div class="control-group">
<label for="inputError" class="control-label">City</label>
<div class="controls">
<input type="text" id="city_name" name="city_name" value="<?php echo $city[0]['name']; ?>" >
</div>
</div>
